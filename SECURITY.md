...
|-------|----------|----------|------|----------|
| autoskill | 🔴 CRITICAL | 9 | ❌ | 5.2s |
| citation-management | 🔴 CRITICAL | 10 | ❌ | 1.5s |
| clinical-decision-support | 🔴 CRITICAL | 6 | ❌ | 7.6s |
| clinical-reports | 🔴 CRITICAL | 6 | ❌ | 3.6s |
| hypothesis-generation | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| infographics | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| latex-posters | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| literature-review | 🔴 CRITICAL | 6 | ❌ | 2.5s |
| markitdown | 🔴 CRITICAL | 7 | ❌ | 2.1s |
| peer-review | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| pptx-posters | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| research-grants | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| research-lookup | 🔴 CRITICAL | 12 | ❌ | 4.8s |
| scholar-evaluation | 🔴 CRITICAL | 6 | ❌ | 1.4s |
| scientific-critical-thinking | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| scientific-schematics | 🔴 CRITICAL | 6 | ❌ | 0.4s |
| scientific-slides | 🔴 CRITICAL | 10 | ❌ | 2.6s |
| scientific-writing | 🔴 CRITICAL | 6 | ❌ | 1.4s |
| treatment-plans | 🔴 CRITICAL | 6 | ❌ | 4.1s |
| venue-templates | 🔴 CRITICAL | 6 | ❌ | 2.7s |
| esm | 🟠 HIGH | 2 | ❌ | 0.0s |
| geomaster | 🟠 HIGH | 4 | ❌ | 0.0s |
| modal | 🟠 HIGH | 6 | ❌ | 0.0s |
| pathml | 🟠 HIGH | 5 | ❌ | 0.0s |
| polars | 🟠 HIGH | 2 | ❌ | 0.0s |
| pytorch-lightning | 🟠 HIGH | 2 | ❌ | 0.1s |
| qutip | 🟠 HIGH | 2 | ❌ | 0.0s |
| sympy | 🟠 HIGH | 2 | ❌ | 0.0s |
...
| labarchive-integration | 🟡 MEDIUM | 4 | ✅ | 2.4s |
| open-notebook | 🟡 MEDIUM | 16 | ✅ | 1.8s |
| phylogenetics | 🟡 MEDIUM | 5 | ✅ | 1.1s |
| protocolsio-integration | 🟡 MEDIUM | 3 | ✅ | 0.0s |
| pymatgen | 🟡 MEDIUM | 2 | ✅ | 2.6s |
| adaptyv | ⚪ INFO | 1 | ✅ | 0.0s |
| aeon | ⚪ INFO | 1 | ✅ | 0.0s |
| anndata | ⚪ INFO | 1 | ✅ | 0.0s |
...
| datamol | ⚪ INFO | 1 | ✅ | 0.0s |
| deepchem | ⚪ INFO | 1 | ✅ | 2.1s |
| deeptools | ⚪ INFO | 1 | ✅ | 1.0s |
| depmap | ⚪ INFO | 1 | ✅ | 0.0s |
| dhdna-profiler | ⚪ INFO | 1 | ✅ | 0.0s |
| diffdock | ⚪ INFO | 1 | ✅ | 3.1s |
| dnanexus-integration | ⚪ INFO | 1 | ✅ | 0.0s |
| docx | ⚪ INFO | 1 | ✅ | 3.6s |
| etetoolkit | ⚪ INFO | 1 | ✅ | 1.7s |
| exploratory-data-analysis | ⚪ INFO | 1 | ✅ | 2.3s |
| flowio | ⚪ INFO | 1 | ✅ | 0.0s |
| fluidsim | ⚪ INFO | 1 | ✅ | 0.0s |
| generate-image | ⚪ INFO | 1 | ✅ | 1.0s |
| geniml | ⚪ INFO | 1 | ✅ | 0.0s |
| geopandas | ⚪ INFO | 1 | ✅ | 0.0s |
| get-available-resources | ⚪ INFO | 1 | ✅ | 1.4s |
| gget | ⚪ INFO | 1 | ✅ | 2.1s |
...
| scientific-visualization | ⚪ INFO | 1 | ✅ | 1.5s |
| scikit-bio | ⚪ INFO | 1 | ✅ | 0.0s |
| scikit-learn | ⚪ INFO | 1 | ✅ | 1.8s |
...
| shap | ⚪ INFO | 1 | ✅ | 0.0s |
| simpy | ⚪ INFO | 1 | ✅ | 0.4s |
| stable-baselines3 | ⚪ INFO | 1 | ✅ | 0.5s |
| statistical-analysis | ⚪ INFO | 1 | ✅ | 1.9s |
| statsmodels | ⚪ INFO | 1 | ✅ | 0.0s |
| tiledbvcf | ⚪ INFO | 1 | ✅ | 0.0s |
| timesfm-forecasting | ⚪ INFO | 1 | ✅ | 8.5s |
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  ...
  > **Remediation:** Review data flow across files: scripts/run.py, scripts/backends.py, tests/test_e2e.py, tests/test_fetch_window.py, tests/test_backends.py, tests/test_run.py, scripts/doctor.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  > Multi-file exfiltration chain detected: scripts/run.py, scripts/backends.py, scripts/doctor.py collect data → tests/smoke_lmstudio.py, scripts/run.py → tests/test_backends.py, tests/test_run.py, tests/test_fetch_window.py, tests/test_e2e.py, scripts/run.py, scripts/backends.py, scripts/doctor.py transmit to network
  > **Remediation:** Review data flow across files: scripts/run.py, scripts/backends.py, tests/test_e2e.py, tests/test_fetch_window.py, tests/test_backends.py, tests/test_run.py, scripts/doctor.py, tests/smoke_lmstudio.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/search_pubmed.py, scripts/doi_to_bibtex.py, scripts/generate_schematic_ai.py, scripts/extract_metadata.py, scripts/generate_schematic.py, scripts/validate_citations.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 3 files
  > Environment variable access with network calls in scripts/generate_schematic.py, scripts/generate_schematic_ai.py, scripts/convert_with_ai.py
  > **Remediation:** Review data flow across files: scripts/convert_with_ai.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 3 files
  > Multi-file exfiltration chain detected: scripts/generate_schematic.py, scripts/generate_schematic_ai.py, scripts/convert_with_ai.py collect data → scripts/generate_schematic_ai.py → scripts/generate_schematic_ai.py transmit to network
  > **Remediation:** Review data flow across files: scripts/convert_with_ai.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  > Environment variable access with network calls in research_lookup.py, examples.py, lookup.py, scripts/generate_schematic.py, scripts/generate_schematic_ai.py, scripts/research_lookup.py
  > **Remediation:** Review data flow across files: scripts/research_lookup.py, research_lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py, examples.py, lookup.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 6 files
  > Multi-file exfiltration chain detected: research_lookup.py, examples.py, lookup.py, scripts/generate_schematic.py, scripts/generate_schematic_ai.py, scripts/research_lookup.py collect data → scripts/generate_schematic_ai.py → research_lookup.py, scripts/generate_schematic_ai.py, scripts/research_lookup.py transmit to network
  > **Remediation:** Review data flow across files: scripts/research_lookup.py, research_lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py, examples.py, lookup.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 3 files
  > Environment variable access with network calls in scripts/generate_schematic.py, scripts/generate_schematic_ai.py
  > **Remediation:** Review data flow across files: scripts/generate_image.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 3 files
  > Multi-file exfiltration chain detected: scripts/generate_schematic.py, scripts/generate_schematic_ai.py collect data → scripts/generate_schematic_ai.py, scripts/generate_image.py → scripts/generate_schematic_ai.py, scripts/generate_image.py transmit to network
  > **Remediation:** Review data flow across files: scripts/generate_image.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
