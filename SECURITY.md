...
**Generated:** 2026-07-27 12:28 UTC  
**Skills scanned:** 138  
**Total findings:** 505  
...
|-------|----------|----------|------|----------|
| autoskill | 🔴 CRITICAL | 9 | ❌ | 7.0s |
| citation-management | 🔴 CRITICAL | 10 | ❌ | 2.0s |
| clinical-decision-support | 🔴 CRITICAL | 6 | ❌ | 10.1s |
| clinical-reports | 🔴 CRITICAL | 6 | ❌ | 4.8s |
| hypothesis-generation | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| infographics | 🔴 CRITICAL | 6 | ❌ | 0.7s |
| latex-posters | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| literature-review | 🔴 CRITICAL | 6 | ❌ | 3.4s |
| markitdown | 🔴 CRITICAL | 7 | ❌ | 2.9s |
| peer-review | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| pptx-posters | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| research-grants | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| research-lookup | 🔴 CRITICAL | 12 | ❌ | 6.5s |
| scholar-evaluation | 🔴 CRITICAL | 6 | ❌ | 1.9s |
| scientific-critical-thinking | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| scientific-schematics | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| scientific-slides | 🔴 CRITICAL | 10 | ❌ | 3.5s |
| scientific-writing | 🔴 CRITICAL | 6 | ❌ | 1.9s |
| treatment-plans | 🔴 CRITICAL | 6 | ❌ | 5.5s |
...
| phylogenetics | 🟡 MEDIUM | 5 | ✅ | 1.5s |
| protocolsio-integration | 🟡 MEDIUM | 3 | ✅ | 0.0s |
| pymatgen | 🟡 MEDIUM | 2 | ✅ | 3.5s |
| adaptyv | ⚪ INFO | 1 | ✅ | 0.0s |
| aeon | ⚪ INFO | 1 | ✅ | 0.0s |
| anndata | ⚪ INFO | 1 | ✅ | 0.0s |
...
| market-research-reports | ⚪ INFO | 1 | ✅ | 1.1s |
| matchms | ⚪ INFO | 1 | ✅ | 0.0s |
| matlab | ⚪ INFO | 1 | ✅ | 0.0s |
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  ...
  > **Remediation:** Review data flow across files: tests/test_e2e.py, scripts/doctor.py, scripts/backends.py, tests/test_fetch_window.py, scripts/run.py, tests/test_run.py, tests/test_backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  ...
  > **Remediation:** Review data flow across files: tests/test_e2e.py, scripts/doctor.py, scripts/backends.py, tests/smoke_lmstudio.py, tests/test_fetch_window.py, scripts/run.py, tests/test_run.py, tests/test_backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/extract_metadata.py, scripts/generate_schematic.py, scripts/search_pubmed.py, scripts/generate_schematic_ai.py, scripts/doi_to_bibtex.py, scripts/validate_citations.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 3 files
  > Environment variable access with network calls in scripts/generate_schematic.py, scripts/generate_schematic_ai.py
  > **Remediation:** Review data flow across files: scripts/verify_citations.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/generate_schematic.py, scripts/research_lookup.py, lookup.py, scripts/generate_schematic_ai.py, research_lookup.py, examples.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 4 files
  ...
  > **Remediation:** Review data flow across files: scripts/generate_schematic_ai.py, scripts/generate_slide_image.py, scripts/generate_slide_image_ai.py, scripts/generate_schematic.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 3 files
  > Environment variable access with network calls in scripts/generate_schematic.py, scripts/generate_schematic_ai.py
  > **Remediation:** Review data flow across files: scripts/generate_schematic_ai.py, scripts/generate_image.py, scripts/generate_schematic.py
