...
**Generated:** 2026-07-13 12:11 UTC  
**Skills scanned:** 138  
**Total findings:** 505  
...
| citation-management | 🔴 CRITICAL | 10 | ❌ | 2.1s |
| clinical-decision-support | 🔴 CRITICAL | 6 | ❌ | 10.2s |
| clinical-reports | 🔴 CRITICAL | 6 | ❌ | 4.9s |
...
| research-lookup | 🔴 CRITICAL | 12 | ❌ | 6.6s |
...
| exploratory-data-analysis | ⚪ INFO | 1 | ✅ | 3.1s |
| flowio | ⚪ INFO | 1 | ✅ | 0.0s |
...
| timesfm-forecasting | ⚪ INFO | 1 | ✅ | 11.1s |
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  ...
  > **Remediation:** Review data flow across files: scripts/doctor.py, tests/test_run.py, tests/test_e2e.py, tests/test_fetch_window.py, scripts/run.py, tests/test_backends.py, scripts/backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  ...
  > **Remediation:** Review data flow across files: scripts/doctor.py, tests/test_run.py, tests/test_e2e.py, tests/test_fetch_window.py, scripts/run.py, tests/test_backends.py, scripts/backends.py, tests/smoke_lmstudio.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/extract_metadata.py, scripts/validate_citations.py, scripts/generate_schematic.py, scripts/search_pubmed.py, scripts/generate_schematic_ai.py, scripts/doi_to_bibtex.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/generate_schematic.py, research_lookup.py, examples.py, scripts/research_lookup.py, scripts/generate_schematic_ai.py, lookup.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 4 files
  ...
  > **Remediation:** Review data flow across files: scripts/generate_slide_image.py, scripts/generate_schematic_ai.py, scripts/generate_slide_image_ai.py, scripts/generate_schematic.py
