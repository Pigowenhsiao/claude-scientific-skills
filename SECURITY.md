...
**Generated:** 2026-05-25 12:37 UTC  
**Skills scanned:** 138  
**Total findings:** 505  
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  ...
  > **Remediation:** Review data flow across files: scripts/backends.py, scripts/doctor.py, tests/test_e2e.py, tests/test_fetch_window.py, tests/test_backends.py, scripts/run.py, tests/test_run.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  ...
  > **Remediation:** Review data flow across files: scripts/backends.py, scripts/doctor.py, tests/test_e2e.py, tests/test_fetch_window.py, tests/test_backends.py, scripts/run.py, tests/smoke_lmstudio.py, tests/test_run.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/search_pubmed.py, scripts/extract_metadata.py, scripts/doi_to_bibtex.py, scripts/generate_schematic.py, scripts/validate_citations.py, scripts/generate_schematic_ai.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: research_lookup.py, examples.py, scripts/research_lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py, lookup.py
