...
**Generated:** 2026-08-03 12:29 UTC  
**Skills scanned:** 138  
**Total findings:** 505  
...
| neuropixels-analysis | ⚪ INFO | 1 | ✅ | 4.1s |
...
| timesfm-forecasting | ⚪ INFO | 1 | ✅ | 10.7s |
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  ...
  > **Remediation:** Review data flow across files: scripts/backends.py, tests/test_e2e.py, scripts/run.py, scripts/doctor.py, tests/test_fetch_window.py, tests/test_run.py, tests/test_backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  ...
  > **Remediation:** Review data flow across files: tests/smoke_lmstudio.py, scripts/backends.py, tests/test_e2e.py, scripts/run.py, scripts/doctor.py, tests/test_fetch_window.py, tests/test_run.py, tests/test_backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: scripts/extract_metadata.py, scripts/doi_to_bibtex.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py, scripts/search_pubmed.py, scripts/validate_citations.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  ...
  > **Remediation:** Review data flow across files: examples.py, scripts/research_lookup.py, lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py, research_lookup.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 4 files
  ...
  > **Remediation:** Review data flow across files: scripts/generate_slide_image.py, scripts/generate_slide_image_ai.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
