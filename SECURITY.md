...
**Generated:** 2026-07-20 11:49 UTC  
**Skills scanned:** 138  
**Total findings:** 505  
...
|-------|----------|----------|------|----------|
| autoskill | 🔴 CRITICAL | 9 | ❌ | 5.5s |
| citation-management | 🔴 CRITICAL | 10 | ❌ | 1.7s |
| clinical-decision-support | 🔴 CRITICAL | 6 | ❌ | 8.0s |
| clinical-reports | 🔴 CRITICAL | 6 | ❌ | 3.9s |
| hypothesis-generation | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| infographics | 🔴 CRITICAL | 6 | ❌ | 0.6s |
| latex-posters | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| literature-review | 🔴 CRITICAL | 6 | ❌ | 2.7s |
| markitdown | 🔴 CRITICAL | 7 | ❌ | 2.3s |
| peer-review | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| pptx-posters | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| research-grants | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| research-lookup | 🔴 CRITICAL | 12 | ❌ | 5.3s |
| scholar-evaluation | 🔴 CRITICAL | 6 | ❌ | 1.5s |
| scientific-critical-thinking | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| scientific-schematics | 🔴 CRITICAL | 6 | ❌ | 0.5s |
| scientific-slides | 🔴 CRITICAL | 10 | ❌ | 2.9s |
| scientific-writing | 🔴 CRITICAL | 6 | ❌ | 1.6s |
| treatment-plans | 🔴 CRITICAL | 6 | ❌ | 4.4s |
| venue-templates | 🔴 CRITICAL | 6 | ❌ | 2.9s |
| esm | 🟠 HIGH | 2 | ❌ | 0.0s |
...
| labarchive-integration | 🟡 MEDIUM | 4 | ✅ | 2.5s |
| open-notebook | 🟡 MEDIUM | 16 | ✅ | 1.9s |
| phylogenetics | 🟡 MEDIUM | 5 | ✅ | 1.2s |
| protocolsio-integration | 🟡 MEDIUM | 3 | ✅ | 0.0s |
| pymatgen | 🟡 MEDIUM | 2 | ✅ | 2.8s |
| adaptyv | ⚪ INFO | 1 | ✅ | 0.0s |
| aeon | ⚪ INFO | 1 | ✅ | 0.0s |
| anndata | ⚪ INFO | 1 | ✅ | 0.0s |
...
| datamol | ⚪ INFO | 1 | ✅ | 0.0s |
| deepchem | ⚪ INFO | 1 | ✅ | 2.2s |
| deeptools | ⚪ INFO | 1 | ✅ | 1.1s |
| depmap | ⚪ INFO | 1 | ✅ | 0.0s |
| dhdna-profiler | ⚪ INFO | 1 | ✅ | 0.0s |
| diffdock | ⚪ INFO | 1 | ✅ | 3.3s |
| dnanexus-integration | ⚪ INFO | 1 | ✅ | 0.0s |
| docx | ⚪ INFO | 1 | ✅ | 3.9s |
| etetoolkit | ⚪ INFO | 1 | ✅ | 1.8s |
| exploratory-data-analysis | ⚪ INFO | 1 | ✅ | 2.4s |
| flowio | ⚪ INFO | 1 | ✅ | 0.0s |
| fluidsim | ⚪ INFO | 1 | ✅ | 0.0s |
| generate-image | ⚪ INFO | 1 | ✅ | 1.0s |
| geniml | ⚪ INFO | 1 | ✅ | 0.0s |
| geopandas | ⚪ INFO | 1 | ✅ | 0.0s |
| get-available-resources | ⚪ INFO | 1 | ✅ | 1.5s |
| gget | ⚪ INFO | 1 | ✅ | 2.2s |
| ginkgo-cloud-lab | ⚪ INFO | 1 | ✅ | 0.0s |
| glycoengineering | ⚪ INFO | 1 | ✅ | 0.0s |
| gtars | ⚪ INFO | 1 | ✅ | 0.0s |
| histolab | ⚪ INFO | 1 | ✅ | 0.0s |
| hugging-science | ⚪ INFO | 1 | ✅ | 1.3s |
| hypogenic | ⚪ INFO | 1 | ✅ | 0.0s |
| iso-13485-certification | ⚪ INFO | 1 | ✅ | 0.3s |
| lamindb | ⚪ INFO | 1 | ✅ | 0.0s |
| latchbio-integration | ⚪ INFO | 1 | ✅ | 0.0s |
| markdown-mermaid-writing | ⚪ INFO | 1 | ✅ | 0.0s |
| market-research-reports | ⚪ INFO | 1 | ✅ | 0.8s |
| matchms | ⚪ INFO | 1 | ✅ | 0.0s |
| matlab | ⚪ INFO | 1 | ✅ | 0.0s |
| matplotlib | ⚪ INFO | 1 | ✅ | 3.3s |
| medchem | ⚪ INFO | 1 | ✅ | 2.0s |
| molecular-dynamics | ⚪ INFO | 1 | ✅ | 0.0s |
| molfeat | ⚪ INFO | 1 | ✅ | 0.0s |
| networkx | ⚪ INFO | 1 | ✅ | 0.0s |
| neurokit2 | ⚪ INFO | 1 | ✅ | 0.0s |
| neuropixels-analysis | ⚪ INFO | 1 | ✅ | 3.4s |
| omero-integration | ⚪ INFO | 1 | ✅ | 0.0s |
| opentrons-integration | ⚪ INFO | 1 | ✅ | 0.7s |
...
| scientific-visualization | ⚪ INFO | 1 | ✅ | 1.7s |
| scikit-bio | ⚪ INFO | 1 | ✅ | 0.0s |
| scikit-learn | ⚪ INFO | 1 | ✅ | 1.9s |
...
| shap | ⚪ INFO | 1 | ✅ | 0.0s |
| simpy | ⚪ INFO | 1 | ✅ | 0.5s |
| stable-baselines3 | ⚪ INFO | 1 | ✅ | 0.6s |
| statistical-analysis | ⚪ INFO | 1 | ✅ | 2.0s |
| statsmodels | ⚪ INFO | 1 | ✅ | 0.0s |
| tiledbvcf | ⚪ INFO | 1 | ✅ | 0.0s |
| timesfm-forecasting | ⚪ INFO | 1 | ✅ | 8.7s |
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 7 files
  > Environment variable access with network calls in scripts/doctor.py, scripts/backends.py, scripts/run.py
  > **Remediation:** Review data flow across files: scripts/run.py, tests/test_fetch_window.py, tests/test_e2e.py, tests/test_run.py, tests/test_backends.py, scripts/doctor.py, scripts/backends.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 8 files
  > Multi-file exfiltration chain detected: scripts/doctor.py, scripts/backends.py, scripts/run.py collect data → scripts/run.py, tests/smoke_lmstudio.py → scripts/doctor.py, scripts/backends.py, scripts/run.py, tests/test_backends.py, tests/test_fetch_window.py, tests/test_e2e.py, tests/test_run.py transmit to network
  > **Remediation:** Review data flow across files: scripts/run.py, tests/test_fetch_window.py, tests/test_e2e.py, tests/smoke_lmstudio.py, tests/test_run.py, tests/test_backends.py, scripts/doctor.py, scripts/backends.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  > Environment variable access with network calls in scripts/search_pubmed.py, scripts/extract_metadata.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
  > **Remediation:** Review data flow across files: scripts/extract_metadata.py, scripts/generate_schematic_ai.py, scripts/validate_citations.py, scripts/doi_to_bibtex.py, scripts/generate_schematic.py, scripts/search_pubmed.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 6 files
  > Multi-file exfiltration chain detected: scripts/search_pubmed.py, scripts/extract_metadata.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py collect data → scripts/generate_schematic_ai.py → scripts/search_pubmed.py, scripts/extract_metadata.py, scripts/doi_to_bibtex.py, scripts/generate_schematic_ai.py, scripts/validate_citations.py transmit to network
  > **Remediation:** Review data flow across files: scripts/extract_metadata.py, scripts/generate_schematic_ai.py, scripts/validate_citations.py, scripts/doi_to_bibtex.py, scripts/generate_schematic.py, scripts/search_pubmed.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 3 files
  > Multi-file exfiltration chain detected: scripts/generate_schematic_ai.py, scripts/generate_schematic.py collect data → scripts/generate_schematic_ai.py → scripts/verify_citations.py, scripts/generate_schematic_ai.py transmit to network
  > **Remediation:** Review data flow across files: scripts/generate_schematic.py, scripts/verify_citations.py, scripts/generate_schematic_ai.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 3 files
  > Environment variable access with network calls in scripts/convert_with_ai.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 3 files
  > Multi-file exfiltration chain detected: scripts/convert_with_ai.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py collect data → scripts/generate_schematic_ai.py → scripts/generate_schematic_ai.py transmit to network
  > **Remediation:** Review data flow across files: scripts/generate_schematic.py, scripts/convert_with_ai.py, scripts/generate_schematic_ai.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_ENV_VAR_EXFILTRATION` — Cross-file env var exfiltration: 6 files
  > Environment variable access with network calls in lookup.py, examples.py, research_lookup.py, scripts/research_lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py
  > **Remediation:** Review data flow across files: research_lookup.py, scripts/generate_schematic_ai.py, lookup.py, scripts/research_lookup.py, scripts/generate_schematic.py, examples.py

- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 6 files
  > Multi-file exfiltration chain detected: lookup.py, examples.py, research_lookup.py, scripts/research_lookup.py, scripts/generate_schematic_ai.py, scripts/generate_schematic.py collect data → scripts/generate_schematic_ai.py → research_lookup.py, scripts/research_lookup.py, scripts/generate_schematic_ai.py transmit to network
  > **Remediation:** Review data flow across files: research_lookup.py, scripts/generate_schematic_ai.py, lookup.py, scripts/research_lookup.py, scripts/generate_schematic.py, examples.py
...
- **🔴 CRITICAL** `BEHAVIOR_CROSSFILE_EXFILTRATION_CHAIN` — Cross-file exfiltration chain: 3 files
  > Multi-file exfiltration chain detected: scripts/generate_schematic_ai.py, scripts/generate_schematic.py collect data → scripts/generate_image.py, scripts/generate_schematic_ai.py → scripts/generate_image.py, scripts/generate_schematic_ai.py transmit to network
  > **Remediation:** Review data flow across files: scripts/generate_image.py, scripts/generate_schematic.py, scripts/generate_schematic_ai.py
